...
import static io.toast.tk.core.adapter.ActionAdapterSentenceRef.AddValueInVar;
import static io.toast.tk.core.adapter.ActionAdapterSentenceRef.DiviserVarByValue;
import static io.toast.tk.core.adapter.ActionAdapterSentenceRef.MultiplyVarByValue;
import static io.toast.tk.core.adapter.ActionAdapterSentenceRef.RemplacerVarParValue;
import static io.toast.tk.core.adapter.ActionAdapterSentenceRef.SubstractValueFromVar;
...
public abstract class AbstractCommonActionAdapter {
	...
	public ITestResult setValToVar(
		String value,
		String var)
		throws Exception {
		repo.getUserVariables().put(var, value);
