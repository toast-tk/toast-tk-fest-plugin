...
import io.toast.tk.adapter.swing.component.SwingMenuElement;
import io.toast.tk.adapter.swing.component.SwingMenuItemElement;
import io.toast.tk.adapter.swing.component.SwingSynTimeLineElement;
...
public class SwingComponentFactory implements ISwingComponentFactory {

	@Override
	public SwingAutoElement getElement(ISwingElementDescriptor element) {
		switch(element.getType()) {
			...
			default:
				return new SwingAutoElement(element);
		}
	}
